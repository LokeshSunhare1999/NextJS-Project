...
import { RUPEE_SYMBOL, YEAR_MEMBERSHIP_PRICE } from "@/constants";

export default function FreeJobBannerMweb({
  freeJobPostAvailable = 5,
  handleCtaClick,
  ...
  return (
    <div className="pt-2">
      <div className="w-full h-auto p-5 flex flex-col items-center bgBase membershipBgMweb relative rounded-lg">
        <div className={`flex items-center w-full `}>
          <div className="flex gap-3">
            <div className="flex flex-col gap-1">
              <p className="text-[16px] leading-[24px] font-semibold text-[#FFFFFF]">
                Post Unlimited Jobs for 12 Months
              </p>
              <p className="text-[12px] leading-[20px] font-medium text-[#D7D8F6]">
