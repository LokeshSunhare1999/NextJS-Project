...
const FileUploadJD = ({
  ...
  const {
    ...
    generateUploadFilePath("JOB_DESCRIPTION", employerId, FILE_TYPES.DOCUMENT),
  ...
  useEffect(() => {
    if (uploadStatus === "success") {
      setTempDelete(false);
      setJobDescriptionUrl(uploadData?.fileLink);
