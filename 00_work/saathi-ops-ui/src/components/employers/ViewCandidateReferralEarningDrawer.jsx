...
import useEmployerCandidateReferralHistory from '../../hooks/employer/useEmployerCandidateReferralHistory';
...
const ViewCandidateReferralEarningDrawer = ({
  open,
  toggleDrawer,
  candidateId,
  candidateName,
  ...
  } = useEmployerCandidateReferralHistory(userId, candidateId, false); // id, candidateId, type
            ...
            {!isEmployerCandidateReferralHistoryError ? (
              <Suspense fallback={<BoxLoader size={5} />}>
                <DisplayTable
                  ...
                  rows={employerCandidateReferralHistoryRows}
...
ViewCandidateReferralEarningDrawer.propTypes = {
  open: PropTypes.bool.isRequired,
  toggleDrawer: PropTypes.func.isRequired,
  candidateId: PropTypes.string,
};

export default ViewCandidateReferralEarningDrawer;
