...
const ViewCustomerCourseDrawer = ({ open, toggleDrawer, courseObj }) => {
  const {
    progressHeaderKeys,
    progressHeaders,
    progressHeaderTypes,
    ...
    handleTrophyClick,
  } = useCustomerCourseProgress(courseObj);
            ...
            <StyledDiv $justifyContent={'space-between'} $gap={'20px'}>
              ...
              <StyledDiv>
                <CustomCTA
                  ...
                  opacity={trophyLink?.length > 0 ? 1 : 0.5}
                  disabled={trophyLink?.length === 0}
                />
                <CustomCTA
...
ViewCustomerCourseDrawer.propTypes = {
  open: PropTypes.bool.isRequired,
  toggleDrawer: PropTypes.func.isRequired,
  courseObj: PropTypes.object.isRequired,
};

export default ViewCustomerCourseDrawer;
