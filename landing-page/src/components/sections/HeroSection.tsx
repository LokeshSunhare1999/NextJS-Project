...
export default function HeroSection() {
  return (
    <section id="hero" className="relative bg-[url('/herobg.webp')] bg-cover bg-center bg-no-repeat h-screen w-full flex flex-col items-center overflow-hidden mt-0 pt-0">
      {/* Background image */}
