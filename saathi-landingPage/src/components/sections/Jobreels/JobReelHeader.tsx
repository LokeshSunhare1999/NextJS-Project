    ...
    <div className="w-full bg-black h-fit flex ">
      <div className="pb-2 sm:pb-4 pt-1 sm:pt-4 md:pt-20 px-0 w-full "> 
        ...
        >
          ...
          <p className="text-gray-400 italic text-md sm:text-md md:text-[18px] py-1 ">
            {subtitle}
          </p>
          <div className="mt-1 md:mt-2">
            <h2 className="text-white text-2xl sm:text-3xl md:text-4xl font-light pb-4 md:pb-4 ">
              {description}
            </h2>
            <h4 className="text-gray-400 text-lg sm:text-xl md:text-2xl font-light">
              {description2}
            </h4>
          </div>
        </div>
